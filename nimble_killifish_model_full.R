...
code1 <- nimbleCode({
  ...
  #=====================================================================================
  philength.LP ~ dnorm(0.03, 0.010) #From Analysis with Interaction
  philength.KO ~ dnorm(0.03, 0.017) #From Analysis with Interaction
...
inits <- list(
  ...
  f.beta = rep(0, 6),
  d.beta = rep(0, 6),
  philength.LP = 0.03,#rnorm(1, 0, 0.25),
  philength.KO = 0.03,#rnorm(1, 0, 0.25),
  rholength.LP = 0.03,#rnorm(1, 0, 0.25),
  rholength.KO = 0.03,#rnorm(1, 0, 0.25),
  H=1,
  g.sigma = 1,
  d.sigma = 1,
